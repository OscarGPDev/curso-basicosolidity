...
contract ContratoVehiculo {
    ...
    function encender() public pure virtual returns (string memory) {
        return "El vehiculo se ha encendido";
    }
    function apagar() public pure virtual returns (string memory) {
        return "El vehiculo se ha encendido";
    }
...
contract ContratoBicicleta is ContratoVehiculo {
    ...
    function encender() public pure override returns (string memory) {
        return "La bicicleta esta lista";
    }
    function apagar() public pure override returns (string memory) {
